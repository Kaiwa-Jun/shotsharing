        ...
        <main className="flex-grow" style={{ minHeight: "150vh" }}>
          <div className="flex flex-col min-h-screen max-w-4xl mx-auto">
            ...
            <div className="my-5">
              ...
              <ul className="max-w-4xl space-y-1 list-decimal  list-inside pl-4 text-sm">
                <li>
            ...
            <div className="my-5">
              ...
              <ul className="max-w-4xl space-y-1  list-decimal list-inside pl-4 text-sm">
                ...
                <li>
                  ...
                  <ul className="pl-5 mt-2 space-y-1 list-alpha list-inside">
            ...
            <div className="my-5">
              <h1 className="text-xl font-bold">第7条（退会）</h1>
              <ul className="max-w-4xl space-y-1  list-decimal list-inside pl-4 text-sm">
                <li>
            ...
            <div className="my-5">
              <h1 className="text-xl font-bold">第10条（利用規約の変更）</h1>
              <ul className="max-w-4xl space-y-1  list-decimal list-inside pl-4 text-sm">
                <li>
            ...
            <div className="my-5">
              <h1 className="text-xl font-bold">第11条（個人情報の取扱い）</h1>
              <p className="max-w-4xl my-2  list-disc list-inside pl-4 text-sm">
                当方は，本サービスの利用によって取得する個人情報については，当方「プライバシーポリシー」に従い適切に取り扱うものとします。
              </p>
            </div>
            <div className="my-5">
              <h1 className="text-xl font-bold">第12条（通知または連絡）</h1>
              <p className="max-w-4xl my-2  list-disc list-inside pl-4 text-sm">
            ...
            <div className="my-5">
              <h1 className="text-xl font-bold">第14条（準拠法・裁判管轄）</h1>
              <ul className="max-w-4xl space-y-1  list-decimal list-inside pl-4 text-sm">
