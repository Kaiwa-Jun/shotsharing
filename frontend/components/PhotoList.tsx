              ...
              (
                ...
                >
                  ...
                  <div className="relative">
                    {/* ここにいいねとかのアイコン入れる */}
                    <div className="bg-white rounded-full w-8 h-8 absolute top-0 right-24 flex items-center justify-center cursor-pointer">
                      <svg
                    ...
                    <div className="bg-white rounded-full w-8 h-8 absolute top-0 right-12 flex items-center justify-center cursor-pointer">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
